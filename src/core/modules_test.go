...
func TestFlags_UpdateSource(t *testing.T) {
	...
	tests := []struct {
		...
		{"git",
			...
			"git::https://github.com/terraform-aws-modules/terraform-aws-memory-db.git?ref=93facd14e9e3a66704d84a0236a8a3b813f047be", "v2.0.1", false},
		{"git update",
			fields{"", "", gitHubToken, 0, false, nil, true},
			args{"git::https://github.com/terraform-aws-modules/terraform-aws-memory-db.git", "git", ""},
			"git::https://github.com/terraform-aws-modules/terraform-aws-memory-db.git?ref=93facd14e9e3a66704d84a0236a8a3b813f047be", "v2.0.1", false},
		...
		{name: "git hash update",
			...
			want:    "git::https://github.com/terraform-aws-modules/terraform-aws-memory-db.git?ref=93facd14e9e3a66704d84a0236a8a3b813f047be",
			want1:   "v2.0.1",
			wantErr: false},
