...
func TestFlags_UpdateSource(t *testing.T) {
	...
	tests := []struct {
		...
		{"git",
			...
			"git::https://github.com/terraform-aws-modules/terraform-aws-memory-db.git?ref=1897817aae0d48862780375cc878bf5de56a08cb",
			"v3.2.0", false},
		{"git update",
			fields{"", "", gitHubToken, &days, false, nil, true},
			args{"git::https://github.com/terraform-aws-modules/terraform-aws-memory-db.git", "git", ""},
		...
		{name: "git hash update",
			...
			want:    "git::https://github.com/terraform-aws-modules/terraform-aws-memory-db.git?ref=1897817aae0d48862780375cc878bf5de56a08cb",
			want1:   "v3.2.0",
			wantErr: false},
...
func TestFlags_UpdateGithubSource(t *testing.T) {
	...
	tests := []struct {
		...
		{"Pass update", fields{Update: true, GitHubToken: gitHubToken}, args{newModule: "github.com/jameswoolfenden/terraform-http-ip.git"},
			"git::https://github.com/jameswoolfenden/terraform-http-ip.git?ref=e33037668bc4cf5c25f8962c7e8085df4b61623c",
			"v0.4.0", false},
